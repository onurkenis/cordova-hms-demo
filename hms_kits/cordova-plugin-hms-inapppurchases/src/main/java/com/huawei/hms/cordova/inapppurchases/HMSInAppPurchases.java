...
public class HMSInAppPurchases extends HMSCordovaPlugin {
    ...
    private void startActivityWithUri(final String uri, final CallbackContext callbackContext) {
        Log.d(TAG, "startActivityWithUri, url=" + uri);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d(TAG, "new onActivityResult, requestCode=" + requestCode + ", resultCode=" + resultCode + ", intentData=" + (data != null ? data.toUri(0) : "null"));
